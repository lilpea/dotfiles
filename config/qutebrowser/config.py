...
config.bind('<z><u><l>', 'spawn --userscript qute-pass --username-only -d dmenu')
config.bind('<z><p><l>', 'spawn --userscript qute-pass --password-only -d dmenu')
...
## Type: QssColor
c.colors.completion.category.bg = solarized['base3']

## Bottom border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.bottom = solarized['base3']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.top = solarized['base3']

## Foreground color of completion widget category headers.
## Type: QtColor
c.colors.completion.category.fg = solarized['base03']
...
## Type: QssColor
c.colors.completion.match.fg = solarized['base01']

## Foreground color of the matched text in the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.match.fg = solarized['base3']

## Background color of the completion widget for odd rows.
## Type: QssColor
c.colors.completion.odd.bg = solarized['base2']
...
## Type: QssColor
c.colors.completion.scrollbar.fg = solarized['base02']

## Background color for the download bar.
## Type: QssColor
#c.colors.downloads.bar.bg = solarized['base3']
...
## Type: QssColor
c.colors.messages.error.fg = solarized['base03']
...
## Type: QssColor
c.colors.messages.info.fg = solarized['base03']
...
## Type: QssColor
c.colors.messages.warning.fg = solarized['base03']

## Background color for prompts.
## Type: QssColor
c.colors.prompts.bg = solarized['base2']
...
## Type: QssColor
c.colors.prompts.selected.bg = solarized['base1']
...
## Type: QssColor
c.colors.statusbar.caret.fg = solarized['base03']
...
## Type: QssColor
c.colors.statusbar.caret.selection.fg = solarized['base03']

## Background color of the statusbar in command mode.
## Type: QssColor
c.colors.statusbar.command.bg = solarized['base3']

## Foreground color of the statusbar in command mode.
## Type: QssColor
c.colors.statusbar.command.fg = solarized['base03']

## Background color of the statusbar in private browsing + command mode.
## Type: QssColor
c.colors.statusbar.command.private.bg = solarized['base1']

## Foreground color of the statusbar in private browsing + command mode.
## Type: QssColor
c.colors.statusbar.command.private.fg = solarized['base03']
...
## Type: QssColor
c.colors.statusbar.insert.fg = solarized['base03']
...
## Type: QssColor
c.colors.statusbar.normal.fg = solarized['base03']
...
## Type: QssColor
c.colors.statusbar.passthrough.fg = solarized['base03']

## Background color of the statusbar in private browsing mode.
## Type: QssColor
c.colors.statusbar.private.bg = solarized['base1']

## Foreground color of the statusbar in private browsing mode.
## Type: QssColor
c.colors.statusbar.private.fg = solarized['base03']

## Background color of the progress bar.
## Type: QssColor
c.colors.statusbar.progress.bg = solarized['base03']
...
## Type: QssColor
c.colors.statusbar.url.fg = solarized['base03']

## Foreground color of the URL in the statusbar for hovered links.
## Type: QssColor
c.colors.statusbar.url.hover.fg = solarized['base02']

## Foreground color of the URL in the statusbar on successful load
## (http).
## Type: QssColor
c.colors.statusbar.url.success.http.fg = solarized['base03']
